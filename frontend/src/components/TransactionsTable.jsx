      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 border border-gray-300 rounded-md text-sm w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
          />
        </div>
      </div>
            ...
            {filteredTransactions.length > 0 ? (
              filteredTransactions.map((t) => (
                <React.Fragment key={t.id}>
                  <tr 
                    className={`hover:bg-gray-50 transition-colors cursor-pointer ${t.item_count > 0 ? 'bg-blue-50/20' : ''}`}
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-sm text-gray-900">
                      <div className="flex items-center gap-2">
                        {t.description}
                        {t.item_count > 0 && (
                          <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-blue-100 text-blue-700 text-[10px] font-bold">
                    ...
                    <td className={`py-3 px-4 text-sm text-right font-bold ${t.transaction_type === 'income' ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <tr><td colSpan="4" className="py-12 text-center text-gray-500 italic">No transactions found</td></tr>
            )}
          </tbody>
        </table>
      </div>
